...
![Carbide Create: Radiused box joints: 3" x 3" x 3": Initial Joinery](<.gitbook/assets/image (238).png>)

This needs to be divided into fifths (two box and three gaps):

![Carbide Create: Radiused box joints: 3" x 3" x 3": Box Joint Width](<.gitbook/assets/image (49).png>)

And then duplicated and dragged into registration with the desired positioning:

![Carbide Create: Radiused box joints: 3" x 3" x 3": Box Joint Width](<.gitbook/assets/image (147).png>)

Then set the rectangles at the box joint locations to be the height of the box and drag them into position:

![Carbide Create: Radiused box joints: 3" x 3" x 3": Vertical Box Joints](<.gitbook/assets/image (319).png>)
...
![Carbide Create: Radiused box joints: 3" x 3" x 3": Vertical Box Joints](<.gitbook/assets/image (104).png>)

Select the narrow rectangles for the box joints and the inset of the bottom:

![Carbide Create: Radiused box joints: 3" x 3" x 3": Box Joints and Inset Base](<.gitbook/assets/image (55).png>)

And then Boolean union:

![Carbide Create: Radiused box joints: 3" x 3" x 3": Finished Bottom](<.gitbook/assets/image (265).png>)
...
![Carbide Create: Radiused box joints: 3" x 3" x 3": Bottom Box Joints for Sides](<.gitbook/assets/image (38).png>)

### Making the Front/Back

![Carbide Create: Radiused box joints: 3" x 3" x 3": Side after Boolean Union](<.gitbook/assets/image (230).png>)
...
![Carbide Create: Radiused box joints: 3" x 3" x 3": Side before Boolean Union](<.gitbook/assets/image (330).png>)

At which point one simply has to fill in the top and clean up the bottom:

![Carbide Create: Radiused box joints: 3" x 3" x 3": Side](<.gitbook/assets/image (327).png>)

Repeat a similar process for the front/back:

![Carbide Create: Radiused Box joints: 3" x 3" x 3": Side](<.gitbook/assets/image (301).png>)
...
![Carbide Create: Radiused Box joints: 3" x 3" x 3": Side View of Bottom](<.gitbook/assets/image (293).png>)
...
![Carbide Create: Radiused box joints: 3" x 3" x 3": Radius Preview](<.gitbook/assets/image (328).png>)
...
![Carbide Create: Radiused box joints: 3" x 3" x 3": Toolpath Preview](<.gitbook/assets/image (282).png>)

Use that construct to place lines relative to each edge which needs to be radiused:

![Carbide Create: Radiused box joints: 3" x 3" x 3": Radius Lines](<.gitbook/assets/image (112).png>)
...
![OpenSCAD: Modeling Cove Radius Endmill](<.gitbook/assets/image (322).png>)
...
![BlockSCAD: Box: 3" x 3" x 3"](<.gitbook/assets/image (209).png>)
...
![BlockSCAD: Box: 3" x 3" x 3": Box joints](<.gitbook/assets/image (103).png>)
...
![OpenSCAD: Box: 3" x 3" x 3": Intersecting Areas](<.gitbook/assets/image (261).png>)

Modify the module for the box joint cuts to round them off:

![OpenSCAD: Box: 3" x 3" x 3": Radiused Box Joints](<.gitbook/assets/image (83).png>)

Repeating the intersection verifies that the rounding works:

![OpenSCAD: Box: 3" x 3" x 3": Intersecting Thinness](<.gitbook/assets/image (13).png>)
...
![Carbide Create: Box: 3" x 3" x 3": Geometry for V carving](<.gitbook/assets/image (269).png>)

With the rounding working the 3D model is verified:

![OpenSCAD: Box: 3" x 3" x 3": Radius and V carving Relief cut](<.gitbook/assets/image (325).png>)

Including the intersection:

![OpenSCAD: Box: 3" x 3" x 3": Radius and V carving Relief cut intersection](<.gitbook/assets/image (307).png>)

Which once verified, allows us to preview the box:

![OpenSCAD: Box: 3" x 3" x 3": 3D Model](<.gitbook/assets/image (120).png>)
...
![Carbide Create: Box: 3" x 3" x 3": Parts Outline](<.gitbook/assets/image (332).png>)
...
![Carbide Create: Box: 3" x 3" x 3": Radius Toolpath](<.gitbook/assets/image (50).png>)
...
![Carbide Create: Box: 3" x 3" x 3": Profile Toolpath](<.gitbook/assets/image (280).png>)

And preview insofar as is possible:

![Carbide Create: Box: 3" x 3" x 3": Preview using square and V endmills](<.gitbook/assets/image (9).png>)
